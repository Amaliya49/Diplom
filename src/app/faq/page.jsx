...
const FAQ = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "В нашем приложении поддерживаются размеры из различных регионов, включая США, Европу, Великобританию, Россию и Китай."
    },
    {
      question: "Как сохранить любимые размеры?",
      answer: "Вы можете сохранить свои любимые размеры, нажав на кнопку 'Сохранить размер' перед конвертацией."
    },
    {
      question: "Есть ли мобильное приложение?",
      answer: "Да, у нас также имеется мобильная версия."
    }
  ];
